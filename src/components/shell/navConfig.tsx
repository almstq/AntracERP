import {
  ...
  Users, HardHat, ClipboardCheck, BarChart3, Activity, type LucideIcon,
} from 'lucide-react';
...
export const WLI_NAV: ModuleNav = {
  ...
  groups: [
    ...
    { title: 'Reports', items: [
      { to: '/wli/reports', label: 'Revenue vs Repair', icon: BarChart3, allow: [FINANCE_WLI] },
      { to: '/wli/reports/uptime', label: 'Fleet Uptime', icon: Activity, allow: [SUPERVISOR, FINANCE_WLI] },
    ] },
...
export const HQ_NAV: ModuleNav = {
  ...
  groups: [
    ...
    { title: 'Reports', items: [
      { to: '/holding/reports', label: 'WLI Revenue vs Repair', icon: BarChart3, allow: [ROLES.DIRECTOR, ROLES.CFO] },
