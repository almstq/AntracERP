...
export const MOCK_USERS: MockUser[] = [
  ...
  { uid: 'user-gm', displayName: 'Ibrahim WLI', email: 'ibrahim@antrac.com', role: 'wli_gm', orgId: 'sbu-wli', siteIds: ['thilafushi', 'bodufinolhu', 'muthaafushi', 'goidhoo'] },
  { uid: 'user-sm', displayName: 'Ahmed Site', email: 'ahmed@antrac.com', role: 'wli_site_manager', orgId: 'sbu-wli', siteIds: ['thilafushi'] },
  { uid: 'user-mech', displayName: 'Hassan Mech', email: 'hassan@antrac.com', role: 'wli_mechanic', orgId: 'sbu-wli', siteIds: ['thilafushi'] },
  { uid: 'user-proc', displayName: 'Fathima Proc', email: 'fathima@antrac.com', role: 'wli_procurement', orgId: 'sbu-wli', siteIds: ['bodufinolhu'] },
];
...
export const MOCK_TICKETS: MockTicket[] = [
  {
    ...
    siteId: 'thilafushi', raisedById: 'user-sm',
  ...
  },
  {
    ...
    siteId: 'bodufinolhu', raisedById: 'user-sm',
  ...
  },
  {
    ...
    siteId: 'muthaafushi', raisedById: 'user-sm',
